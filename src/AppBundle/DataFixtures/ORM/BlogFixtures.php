...
class BlogFixtures implements FixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $blog1->setTags('symfony2, php, paradise, symblog, hubshark');
        ...
        $blog2->setTags('pool, leaky, hacked, movie, hacking, symblog, hubshark');
        ...
        $blog3->setTags('misdirection, magic, movie, hacking, symblog, hubshark');
        ...
        $blog4->setTags('grid, daftpunk, movie, symblog, hubshark');
        ...
        $blog5->setTags('binary, one, zero, alive, dead, !trusting, movie, symblog, hubshark');
